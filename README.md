...
| `{{fantasy_football.index.0.team1_record}}` | `4-1` | Configured team's overall record |
| `{{fantasy_football.index.0.team2_record}}` | `3-2` | Opponent's overall record |
| `{{fantasy_football.index.0.team1_rank}}` | `2` | Configured team's current ESPN standing |
